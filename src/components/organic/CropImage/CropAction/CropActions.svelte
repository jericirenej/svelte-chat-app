<script lang="ts">
  ...
  import CropAction from "./CropAction.svelte";
...
<div class="flex flex-col gap-3">
  <div class={clsx({ action: true, enabled: !confirmDisabled })}>
    <CropAction disabled={confirmDisabled} action={confirmCallback} type="confirm" />
  </div>
