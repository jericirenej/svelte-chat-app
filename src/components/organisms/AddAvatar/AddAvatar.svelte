...
<script lang="ts">
  ...
  import CroppedAvatar from "../../molecules/CroppedAvatar/CroppedAvatar.svelte";
  import Overlay from "../../molecules/Overlay/Overlay.svelte";
  import Upload from "../../molecules/Upload/Upload.svelte";
